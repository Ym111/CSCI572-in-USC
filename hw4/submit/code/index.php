	...
	?>
		...
		foreach ($results->response->docs as $doc)
		{
			?>
				...
				{
					if($field =="id" || $field =="title" ||$field =="og_description" ){
						?>
						<tr>
					...
					if($field =="og_url"){
						...
						<tr>
						<th><?php echo htmlspecialchars($field, ENT_NOQUOTES, 'utf-8'); ?></th>
						<td> <a href=" <?php echo htmlspecialchars($value, ENT_NOQUOTES, 'utf-8'); ?> "><?php echo htmlspecialchars($value, ENT_NOQUOTES, 'utf-8'); ?></a> </td>
						</tr>
						<?php
					}
